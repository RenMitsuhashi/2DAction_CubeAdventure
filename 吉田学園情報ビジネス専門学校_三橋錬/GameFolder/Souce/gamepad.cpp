...
bool CGamePad::GetAnyButton() const
{
	int nCntPad;
...
bool CGamePad::GetButton(CGamePad::PadButton Button) const
{
...
float CGamePad::PressCrossKey() const
{
	// 十字キーが入力されてるか
	...
	return 0xFFFFFFFF; // 何も押されてなかったとき用
}

float CGamePad::TriggerCrossKey() const
{
	// 十字キーが入力されてるか
	if (m_aPadState.rgdwPOV[0] != 0xFFFFFFFF)
	{
