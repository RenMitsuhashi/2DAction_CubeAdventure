...
HRESULT CRenderer::Init(HWND hWnd, bool bWindow)
{
	...
	m_pCamera = CCamera::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f), 400.0f, D3DXVECTOR3(0.0f, -250.0f, 0.0f));
...
void CRenderer::DrawFPS(void)
{
	...
	str += to_string(nCountFPS);
	
	// テキスト描画
	m_pFont->DrawText(NULL, str.c_str(), -1, &rect, DT_LEFT, D3DCOLOR_ARGB(255, 255, 255, 255));
}
#endif

void CRenderer::SetWindowMode(bool tf, HWND hWnd)
{
	d3dpp.Windowed = tf;
}